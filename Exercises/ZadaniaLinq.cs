...
public sealed class ZadaniaLinq
{
    ...
    public IEnumerable<string> Zadanie04_PierwszyPrzedmiotAnalityczny()
    {
        ...
        if (result == null)
        {
            return new List<string> { "Nie znaleziono Analytics." };
        }
    ...
    public IEnumerable<string> Zadanie05_CzyIstniejeNieaktywneZapisanie()
    {
        var result =  DaneUczelni.Zapisy
            .FirstOrDefault(z => z.CzyAktywny = false);
        if (result == null)
        {
            return new List<string> { "nie ma nieaktywnych" };
        }
        return new List<string> { "jest nieaktywny" };
    ...
    public IEnumerable<string> Zadanie14_SredniaOcenaNaPrzedmiot()
    {
        ...
        return DaneUczelni.Zapisy.Join(
            ...
            .Select(j => $"{j.Key} {j.Average(j=> j.ocenaKoncowa)}");
    }
